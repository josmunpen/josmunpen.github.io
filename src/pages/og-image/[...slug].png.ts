...
const markup = (props: {
	...
	html`<div tw="flex flex-col w-full h-full px-20 py-16" style="background-color: #f6f1e6; font-family: Newsreader;">
		<p tw="text-2xl mb-10 tracking-widest uppercase" style="font-family: JetBrains Mono; color: #8a4423;">
			${props.eyebrow}
		</p>
		<h1 tw="${titleClass(props.title)}" style="color: #25201b; font-weight: 600;">
			${props.title}
		</h1>
		<p tw="text-2xl mb-4" style="font-family: JetBrains Mono; color: #4a4239;">
			${props.byline}
		</p>
		<p tw="text-xl tracking-wider uppercase" style="font-family: JetBrains Mono; color: #8a4423;">
			${props.tagsLine}
		</p>
		<div tw="flex flex-1"></div>
		<div tw="flex justify-end w-full">
			<p tw="text-lg tracking-wide" style="font-family: JetBrains Mono; color: #b8ad9b;">
				${props.host}
			</p>
		</div>
	</div>`;
